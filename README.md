...
If you have been using fastdiract from before fastgdb/fastvim were added, you can run the `migrate.sh` script to convert your fastdir/fastact files to the newest format.
